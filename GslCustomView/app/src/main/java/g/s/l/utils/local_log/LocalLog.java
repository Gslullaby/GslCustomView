...
public class LocalLog {
    ...
    public static void initWithFullDir(String tag, String logDirFullPath, boolean debug) {
        if (!TextUtils.isEmpty(tag)) {
            TAG = tag;
        }
        if(!TextUtils.isEmpty(logDirFullPath)){
            sLogDirFullPath = logDirFullPath;
        }
        isDebug = debug;
        isLogUpload = debug;
    }
    ...
    private static String sLogDirFullPath;//not necessary
    public static String sLogDirName = "/local-log";//default
    ...
    private static void writeToLog(final String logText) {
        if (externalStorageExist()) {
            try {
                LogWriteHelper.writeLogToFile(getLogFileName(new Date()), logText, compositeLogDirFullPath());
            } catch (Throwable e) {
    ...
    private static String compositeLogDirFullPath(){
        if(TextUtils.isEmpty(sLogDirFullPath)){
            return Environment.getExternalStorageDirectory()+sLogDirName;
        }else{
            return sLogDirFullPath;
        }
    }
